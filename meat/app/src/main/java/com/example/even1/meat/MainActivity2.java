...
public class MainActivity2 extends Activity implements LocationSource,
		...
		btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (btn.isChecked()) {
					...
					startActivity(new Intent(MainActivity2.this,Runlist.class));
				}
			}
		});
	...
	protected void saveRecord(List<AMapLocation> list, String time) {
		if (list != null && list.size() > 0) {
			...
			Toast.makeText(MainActivity2.this, "没有记录到路径", Toast.LENGTH_SHORT)
					.show();
		}
	}
	...
	public void record(View view) {
		Intent intent = new Intent(MainActivity2.this, Runlist.class);
