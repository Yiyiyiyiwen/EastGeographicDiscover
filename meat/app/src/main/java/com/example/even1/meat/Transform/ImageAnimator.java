package com.example.even1.meat.Transform;
...
public class ImageAnimator {
    ...
    private final mSimpleAdapter mAdapter; // 适配器
    ...
    public ImageAnimator(mSimpleAdapter adapter, ImageView targetImage, ImageView outgoingImage) {
        mAdapter = adapter;
