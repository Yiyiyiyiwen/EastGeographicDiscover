...
public class DbAdapter {
	...
	/*private final static String DATABASE_PATH = android.os.Environment
			.getExternalStorageDirectory().getAbsolutePath() + "/data/data/com.example.even1.meat/recordPath";*/
	private final static String DATABASE_PATH = "/data/data/com.example.even1.meat/recordPath";
