package com.example.even1.meat.Listener;
...
import com.example.even1.meat.Transform.ImageAnimator;
...
public class PagerChangeListener implements ViewPager.OnPageChangeListener {
    ...
    public static PagerChangeListener newInstance(mSimpleAdapter adapter, ImageView originImage, ImageView outgoingImage) {
